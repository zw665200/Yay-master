...
public class AppUtil {
    ...
    public static void getAllInstalledAppPakageName(Context context) {
        ...
        for (int i = 0; i < apps.size(); i++) {
            ...
            Log.i("appUtil","getAppProcessName: " + name);
            Log.i("appUtil","getAppProcessVersion: " + version);
        }
    }
    ...
    public static void copyApkFromAssets(Context context, String fileName, String path) {
        try {
            ...
            Log.i("appUtil",path + fileName);
            if (!file.exists()) {
                boolean create = file.createNewFile();
                if (!create) return;
            }

            Log.i("appUtil","filename = " + file.getPath());
    ...
    public static int getCurrentNavigationBarHeight(Activity activity) {
        if (isNavigationBarShown(activity)) {
            ...
            Log.i("appUtil","NavigationBar is gone");
            return 0;
        }
    }
