...
import com.netease.yunxin.kit.chatkit.ui.util.DoubleUtils;
...
public class MessageBottomLayout extends FrameLayout
    ...
    public void init(List<ActionItem> items, IMessageProxy proxy) {
        ...
        // init more panel
        mActionsPanel.init(mBinding.chatMessageActionsPanel, ActionFactory.assembleInputMoreActions(), this);
...
//        BottomChoiceDialog dialog = new BottomChoiceDialog(this.getContext(), ActionFactory.assembleVideoCallActions());
//        dialog.setOnChoiceListener(
//                new BottomChoiceDialog.OnChoiceListener() {
//                    @Override
//                    public void onChoice(@NonNull String type) {
